        ...
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="h-10 w-10 flex items-center justify-center rounded border border-[var(--color-border)] text-[var(--color-muted)] hover:text-[var(--color-text)] hover:border-[var(--color-muted)] cursor-pointer transition"
            >
            ...
            <button
              ...
              className="h-10 px-4 flex items-center rounded border border-[var(--color-accent)] text-[var(--color-accent)] hover:bg-[var(--color-accent)] hover:text-black cursor-pointer transition text-sm font-semibold"
            >
              Donate
            </button>
          </div>
        ...
        >
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 w-full h-12 px-4 rounded bg-white text-[#2d2418] font-semibold text-center hover:bg-[#f0f0f0] cursor-pointer transition shadow-sm"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 w-full h-12 px-4 rounded bg-[#0B0E11] text-white font-semibold text-center hover:bg-[#1E2329] cursor-pointer transition shadow-sm border border-[#2a2f38]"
            >
